c jetair7a tries Sushil iclusion of zerocoef
c jetair7 has zerogradient boundary condition on potential
...
c     setting up boundary values
      do 50 j=1,nr
           call zerocoef(dc,df,de,dw,dn,ds,volts,j,1)
 50   continue
      e = 1.60206d-19
      epsilon = 8.85d-14
      mu = 10
...
c         dc(j,1) = 1.0
c         df(j,1) = 0.0
c         df(j,1) = volts * (radius-r(j))/(radius-r(nro))
c  101 continue
