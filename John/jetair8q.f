...
c         write(5,572) (phi(j,i),j=0,nrp)
         write(5,572) (phi(j,i),j=0,nrp3)
 778  continue
         write(5,501)
         write(5,508)
      do 792 i=0,nzp
         write(5,510) i,z(i)
         write(5,572) (ez(j,i),j=0,nrp3)
