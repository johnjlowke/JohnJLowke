c drift velocity ia a function of temperature and pressure 
c rr25d has w values a funftion of pressure and temperature
...
c----------------------------------------------------------------------
      do 10 i=1,nz
      do 11 j=1,nr
c	 df(j,i)=(e/epsilon)*(rnp(j,i)-rne(j,i)-rni(j,i))
	 df(j,i)=0.0
...
c        wiz = -rmob*ez(j,i) rmob is positive so for electrons and neg ions wiz and wize -ve
       ...
       do 194 j=1,nr
c        wiz = -rmob*ez(j,i)
        wiz = -rmob*ez(j,i)*t(j,i)/(300.0*ppp(i))
c drift velocity ia a function of temperature and pressure 
        wize = 100*wiz
