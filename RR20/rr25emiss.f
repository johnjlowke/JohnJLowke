c rr25emiss.f has cathode emission
c rr25.f corrects signs in rr24.f
...
c top electrode flow out or in at i=0 
      do 213 j = 1,nr
          ...
          rjnpz(j,0) = rjnpz(j,1)
          rjnpr(j,0) = rjnpr(j,1) 
c bottom boundary does not emit  particles; flow -ve
          rjnez(j,nzp) = 0.0  
          rjner(j,nzp) = 0.0  
          rjniz(j,nzp) = 0.0  
          rjnir(j,nzp) = 0.0 
          ...
          rjnpr(j,nzp) = 0.0  
 213  continue  
c bottom electrode at i=70 emits electrons
      do 214 j = 1,nra
            rjnez(j,70) = rjnez(j,69)
c       if (j.le.nra) then
c       if (ez(j,i).le.0.0) then
c            rjnez(j,70) = 0.0
c            rjniz(j,70) = 0.0
c            rjnpz(j,70) = rjnpz(j,69) 
c       else
c            rjnez(j,70) = rjnez(j,69)
c            rjniz(j,70) = rjniz(j,69)
c	    rjnpz(j,70) = 0.0
c       endif
c       endif
 214  continue  
c bottom electrode  has particle densities set to zero and does not emit electrons
      do 216 i = 71,nzp
      do 215 j = 0,nra
            rne(j,i) = 0.0
            rni(j,i) = 0.0
...
c          if (rne(j,i).ge.rmaxne) rmaxne = rne(j,i)
...
c          rnet(j,i) = rnp(j,i) - rne(j,i) - rni(j,i)
 ...
 198  continue
c        jj = 3
c            write(*,499) i,rjnez(jj,70),d2dz2,rjnez(jj,71),d2dr2,rion,
c     r    att,dne(jj,70),rne(jj,70),dne(jj,i),rne(jj,i) 
c        i = 66
c        do 301 j=0,nr
