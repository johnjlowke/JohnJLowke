...
c bottom boundary does not emit electrons, neg ions or pos ions
          ...
          rjner(j,nzp) = rjner(j,nz)
          rjniz(j,nzp) = rjniz(j,nz) 
          rjnir(j,nzp) = rjnir(j,nz)
          rjnpz(j,nzp) = rjnpz(j,nz)
          rjnpr(j,nzp) = rjnpr(j,nz) 
          rjnez(j,nzp) = rjnez(j,nz)
          rjniz(j,nzp) = rjniz(j,nz) 
 213  continue  
...
c          dne(j,i) =-((rjner(j,i)*ddrf-rjner(j-1,i)*ddrb)/dr(j) -
     ...
     r        (rjnez(j,i)-rjnez(j,i-1)))*deltel/dz(i)
          if (dne(j,i).ge.rne(j,i)) dne(j,i) = rne(j,i)-1
...
c          dnp(j,i) =-((rjnpr(j,i)*ddrf-rjnpr(j-1,i)*ddrb)/dr(j) -
     ...
     r        (rjnpz(j,i)-rjnpz(j,i-1)))*deltel/dz(i)
          if (dnp(j,i).ge.rnp(j,i)) dnp(j,i) = rnp(j,i)-1
